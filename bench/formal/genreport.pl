...
%desc = (
	"axiluart"	=> "AXI-Lite UART peripheral",
	"rxuartlite"	=> "UART Receiver, lite version",
	"txuartlite"	=> "UART Transmitter, lite version",
	"txuart"	=> "UART Transmitter, full featured",
	"ufifo"		=> "A synchronous FIFO supporting the UART"
	);
## }}}
...
<BODY>
<H1 align=center>Wishbone UART Verification Report</H1>
